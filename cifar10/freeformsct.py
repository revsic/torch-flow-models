...
from flowmodels.freeformsct import FreeformCT
...
def reproduce_cvsct_cifar10():
    ...
    trainer = Cifar10Trainer(
        model,
        batch_size=230,  # // n_gpus // n_grad_accum,
        shuffle=True,
        dataset_path=Path("./"),
        workspace=Path(f"./test.workspace/freeform-cifar10/{stamp}"),
    )
